...
export class ModelComponent implements OnInit {
  ...
  updateMeasurementWidth(widthInput: string) {
    ...
    try {
      this.modelData.measurement.width = eval('[' + widthInput.replace(/[,\s\n\t]\s*/g,', ') + ']')
      this.saveModel()
    }
    catch(err) {
      console.log(err)
  ...
  updateMeasurementLength(lengthInput: string) {
    ...
    try {
      this.modelData.measurement.length = eval('[' + lengthInput.replace(/[,\s\n\t]\s*/g,', ')  + ']')
      this.saveModel()
    }
    catch(err) {
      console.log(err)
  ...
  updateMeasurementFactor(factorInput: string) {
    ...
    try {
      this.modelData.measurement.factor = eval('[' + factorInput.replace(/[,\s\n\t]\s*/g,', ')  + ']')
      this.saveModel()
    }
    catch(err) {
      console.log(err)
